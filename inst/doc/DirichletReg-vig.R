...
###################################################
### code chunk number 23: DirichletReg-vig.Rnw:249-250
###################################################
B2 <- DR_data(BloodSamples[,c(1,2,4)])
plot(B2, cex=.001, reset_par=FALSE)
...
###################################################
### code chunk number 24: DirichletReg-vig.Rnw:256-263
###################################################
RS <- ReadingSkills
...
###################################################
### code chunk number 26: DirichletReg-vig.Rnw:300-301
###################################################
g.ind <- as.numeric(RS$dyslexia)
g1 <- g.ind == 1   # normal
g2 <- g.ind != 1   # dyslexia
...
###################################################
### code chunk number 27: DirichletReg-vig.Rnw:305-309
###################################################
a <- RS$accuracy
logRa_a <- log(a/(1-a))
rlr <- lm(logRa_a~dyslexia*iq, RS)
...
###################################################
### code chunk number 28: DirichletReg-vig.Rnw:311-312
###################################################
summary(rs2)


###################################################
### code chunk number 29: DirichletReg-vig.Rnw:314-316
###################################################
confint(rs2)
...
###################################################
### code chunk number 31: DirichletReg-vig.Rnw:342-343
###################################################
gcol <- c("#E495A5", "#39BEB1")[3-as.numeric(RS$dyslexia)]                      # colorspace : rainbow_hcl(2)
tmt <- c(-3,3)
par(mfrow=c(3,2), cex=.8)
